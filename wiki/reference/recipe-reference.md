...
description: >-
  All event-sheet + layout + workflow recipe ops, SID addressing, builder shorthands, and the numbered recipe gotchas/bugs (read before touching the recipe interpreter/validator)
tags: [reference, recipes, event-sheets, layouts]
status: stable
