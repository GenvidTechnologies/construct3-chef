...
- The family-member attribution rule (member's own `objectClass` on the call
  ...
  `wiki/reference/cli-addons.md` so a future reader doesn't "simplify" it into
