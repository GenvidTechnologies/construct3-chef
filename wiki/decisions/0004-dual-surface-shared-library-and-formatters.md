...
title: "0004. Dual CLI + MCP surface over one shared pure library and shared formatters"
description: >-
  CLI + MCP as thin wrappers over `src/c3/`; shared formatters keep outputs byte-identical across both surfaces
